...
class World(object):
    ...
    def add_weld_box(self, width, length, height, joint_loc, box_rot, joint_name):
        papi.world__addWeldBox(width, length, height, joint_loc[0], joint_loc[1], joint_loc[2], box_rot[0], box_rot[1], box_rot[2], joint_name)
